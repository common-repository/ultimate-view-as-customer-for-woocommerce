...
class Ultimate_View_As_Customer_For_Woocommerce
{
	...
	private function load_dependencies()
	{
		 ...
		 * User Switching
		 */
		if (is_plugin_active('woocommerce/woocommerce.php') && (isset($ultimate_view_as_customer_for_woocommerce_api_settings["settings"]["settings_enable"]) && $ultimate_view_as_customer_for_woocommerce_api_settings["settings"]["settings_enable"])) {
	...
	private function define_admin_hooks()
	{
		...
		if (is_plugin_active('woocommerce/woocommerce.php')) {
			...
			// Save settings by ajax
			$this->loader->add_action('wp_ajax_ultimate_view_as_customer_for_woocommerce_reset_settings_ajax', $plugin_admin, 'ultimate_view_as_customer_for_woocommerce_reset_settings_ajax');
			$this->loader->add_action('wp_ajax_nopriv_ultimate_view_as_customer_for_woocommerce_reset_settings_ajax', $plugin_admin, 'ultimate_view_as_customer_for_woocommerce_reset_settings_ajax');
	...
	private function define_public_hooks()
	{
		...
		if (is_plugin_active('woocommerce/woocommerce.php')) {
			...
			$this->loader->add_action('wp_footer', $plugin_public, 'ultimate_view_as_customer_for_woocommerce_footer_scripts', 9999);
		}
	}
