...
class Ultimate_View_As_Customer_For_Woocommerce_Public
{
	...
	public function ultimate_view_as_customer_for_woocommerce_footer_scripts()
	{
...
?>
		<style id="ultimate_view_as_customer_for_woocommerce_dynamic_style">
			#ultimate_view_as_customer_for_woocommerce_switch_on {
				<?php if (isset($result['color-customizer']['bar_background_color']) && $result['color-customizer']['bar_background_color']): ?>background-color: <?php echo esc_html($result['color-customizer']['bar_background_color']); ?>;
				<?php endif ?><?php if (isset($result['color-customizer']['bar_text_color']) && $result['color-customizer']['bar_text_color']): ?>color: <?php echo esc_html($result['color-customizer']['bar_text_color']); ?>;
				<?php endif ?>
			}

			#ultimate_view_as_customer_for_woocommerce_switch_on .switch-to-another .header-text,
			#ultimate_view_as_customer_for_woocommerce_switch_on .switch-to-old a {
				<?php if (isset($result['color-customizer']['button_background_color']) && $result['color-customizer']['button_background_color']): ?>background-color: <?php echo esc_html($result['color-customizer']['button_background_color']); ?>;
				<?php endif ?><?php if (isset($result['color-customizer']['button_text_color']) && $result['color-customizer']['button_text_color']): ?>color: <?php echo esc_html($result['color-customizer']['button_text_color']); ?>;
				<?php endif ?>
			}
		</style>
<?php
