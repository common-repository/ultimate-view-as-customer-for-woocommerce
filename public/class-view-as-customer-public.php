 ...
 * @subpackage View_As_Customer/public
 */
...
class View_As_Customer_Public
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style($this->plugin_name . '-public', plugin_dir_url(__FILE__) . 'css/view-as-customer-public.css', array(), $this->version, 'all');
	}
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/view-as-customer-public.js', array('jquery'), $this->version, false);
	}
}
